...
from Load_model import Load_SE_model, Load_y_dict
...
def get_args():
    ...
    parser.add_argument('--alpha', type=float, default=0.0) #loss = (1 - self.alpha) * SEloss + self.alpha * ASRloss
    #parser.add_argument('--alpha', type=float, default=0.000009) #loss = (1 - self.alpha) * SEloss + self.alpha * ASRloss
